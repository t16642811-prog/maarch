...
select res_id, alt_identifier, destination, dest_user, status,
       custom_fields -> '_anamWorkflow' ->> 'step' as step,
       custom_fields -> '_anamWorkflow' ->> 'originUserId' as origin_user_id,
       custom_fields::text as custom_fields
from res_letterbox
where res_id = 2607;
