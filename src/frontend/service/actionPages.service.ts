...
export class ActionPagesService {
    ...
    private actionPages: actionPages[] = [
        ...
        {
            'id': 'anam_submit_manager_validation',
            'label': 'Soumettre au chef pour validation',
            'name': 'anam_submit_manager_validation',
            'component': 'anamSubmitManagerValidationAction',
            'category': 'application',
            'description': 'ANAM - Retour du collaborateur vers le chef de service pour validation'
        },
        {
            'id': 'anam_validate_response',
            'label': 'Valider la réponse (ANAM)',
            'name': 'anam_validate_response',
            'component': 'anamValidateResponseAction',
            'category': 'application',
            'description': 'ANAM - Validation par le chef puis retour à Houria'
        },
        {
            'id': 'anam_reject_to_collaborator',
            'label': 'Rejeter au collaborateur (ANAM)',
            'name': 'anam_reject_to_collaborator',
            'component': 'anamRejectToCollaboratorAction',
            'category': 'application',
            'description': 'ANAM - Rejet de la réponse vers l’utilisateur traitant'
        },
        {
