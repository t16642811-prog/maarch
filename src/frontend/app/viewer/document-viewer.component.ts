import { Component, OnInit, Input, ViewChild, EventEmitter, Output, OnDestroy, HostBinding } from '@angular/core';
...
export class DocumentViewerComponent implements OnInit, OnDestroy {
    ...
    @Input() zoom: number = 1;
    @Input() zoomScale: 'page-width' | 'page-fit' | 'page-height' | null = null;

    @Input() chrono: string = '';

    @HostBinding('class.hide-tools') get hideToolsClass(): boolean {
