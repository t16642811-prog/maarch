...
const routes: Routes = [
    ...
    { path: 'forgot-password', canActivate: [AppLightGuard],component: ForgotPasswordComponent },
    { path: 'reset-password', canActivate: [AppLightGuard], component: ResetPasswordComponent },
    { path: 'activate-user', canActivate: [AppLightGuard], component: ActivateUserComponent },
    { path: 'password-modification', canActivate: [AppLightGuard], component: PasswordModificationComponent },
