...
class PreProcessActionController
{
    ...
    {
        $basketId = $args['basketId'] ?? null;
        $useBasketScope = !empty($basketId) && $basketId !== 'null' && is_numeric($basketId);
        if ($useBasketScope) {
        ...
        if (!$useBasketScope) {
            ...
            foreach ($allEntities as $key => $value) {
                ...
                if (!empty($primaryEntity['entity_id']) && $primaryEntity['entity_id'] == $value['entity_id']) {
            ...
            $basket = BasketModel::getById(['id' => $basketId, 'select' => ['basket_id']]);
    ...
    public function checkExternalSignatoryBook(Request $request, Response $response, array $aArgs): Response
    {
        ...
        if (!empty($loadedXml)) {
            ...
            $availableResources = [];
            if (
                in_array($signatureBookEnabled, ['maarchParapheur', 'fastParapheur', 'iParapheur', 'ixbus', 'pastell'])
            ) {
    ...
    public function checkShippings(Request $request, Response $response): Response
    {
        ...
        if (empty($mailevaConfig)) {
            return $response->withJson(
                ['fatalError' => 'Maileva configuration does not exist', 'reason' => 'missingMailevaConfig']
            );
        } elseif (!$mailevaConfig['enabled']) {
            return $response->withJson(
                ['fatalError' => 'Maileva configuration is disabled', 'reason' => 'disabledMailevaConfig']
            );
        }
        ...
        if (!empty($entities)) {
            ...
            foreach ($aTemplates as $key => $value) {
                ...
                if (str_contains($aTemplates[$key]['options']['sendMode'], 'digital_registered_mail')) {
        ...
        if (!empty($aTemplates)) {
            ...
            $resourcesInfo = ResModel::get(
                ['select' => ['alt_identifier', 'res_id'], 'where' => ['res_id in (?)'], 'data' => [$data['resources']]]
            );
                ...
                foreach ($aAttachments as $key => $attachment) {
                    if ($attachment['res_id_master'] == $valueResId) {
                        ...
                        if (
                            ...
                            $canNotSend[] = [
                                'resId'                => $valueResId,
                                'chrono'               => $resourcesChrono[$valueResId],
                                'reason'               => 'noAttachmentConversion',
     ...
     * @throws Exception
     */
    public function checkRejectVisa(Request $request, Response $response, array $args): Response
    {
        $body = $request->getParsedBody();
     ...
     * @throws Exception
     */
    public function checkInterruptResetVisa(Request $request, Response $response, array $args): Response
    {
        $body = $request->getParsedBody();
     ...
     * @throws Exception
     */
    public function checkValidateParallelOpinion(Request $request, Response $response, array $args): Response
    {
        $body = $request->getParsedBody();
     ...
     * @throws Exception
     */
    public function checkGiveParallelOpinion(Request $request, Response $response, array $args): Response
    {
        $body = $request->getParsedBody();
     ...
     * @throws Exception
     */
    public function checkContinueOpinionCircuit(Request $request, Response $response, array $args): Response
    {
        $body = $request->getParsedBody();
     ...
     * @throws Exception
     */
    public function isDestinationChanging(Request $request, Response $response, array $args): Response
    {
     ...
     * @throws Exception
     */
    public static function checkConfirmWithFieldsAction(Request $request, Response $response, array $args): Response
    {
        $body = $request->getParsedBody();
     ...
     * @throws Exception
     */
    public static function checkCloseWithFieldsAction(Request $request, Response $response, array $args): Response
    {
        $body = $request->getParsedBody();
     ...
     * @throws Exception
     */
    public function checkReconcile(Request $request, Response $response, array $args): Response
    {
        $body = $request->getParsedBody();
     ...
     * @throws Exception
     */
    public function checkSendAlfresco(Request $request, Response $response, array $args): Response
    {
        $body = $request->getParsedBody();
     ...
     * @throws Exception
     */
    public function checkSendMultigest(Request $request, Response $response, array $args): Response
    {
        $body = $request->getParsedBody();
     ...
     * @throws Exception
     */
    public function checkPrintDepositList(Request $request, Response $response, array $args): Response
    {
        $body = $request->getParsedBody();
     ...
     * @throws Exception
     */
    private static function getNonLockedResources(array $args): array
    {
