...
class FolderController
{
    ...
    public function getResourcesById(Request $request, Response $response, array $args): Response
    {
        ...
        return $response->withJson(
            ['resources' => $formattedResources, 'countResources' => $count, 'allResources' => $allResources]
        );
    }
     ...
     * @throws Exception
     */
    private static function updateChildren($parentId, $levelParent, $folderOwner): void
    {
